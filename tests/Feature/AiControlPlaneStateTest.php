...
it('exposes bounded repository handoff, guidance, operation bundles, impact-aware verification and resume workflow through the AI status JSON surface', function (): void {
    ...
    expect($state['schema_version'])->toBe(2)
        ...
        ->and($handoff['active_tranche'])->toBe('23.0B')
        ...
        ->and($nextActions['active_tranche'])->toBe('23.0B')
        ...
        ->and($bundles['implement']['active_tranche'])->toBe('23.0B')
        ...
        ->and($resume['active_tranche'])->toBe('23.0B')

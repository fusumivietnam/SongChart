...
final readonly class EntityPassportReadModel
{
    public function __construct(
        ...
        private EntityIdentityBridge $identityBridge,
        private EnrichmentPlanner $enrichmentPlanner,
    ) {}
    ...
    public function for(EntityType $type, Model $entity): array
    {
        ...
        return [
            ...
            'fields' => $resolutions,
            'identity_bridge' => $this->identityBridge->for($type, $entityId)->toArray(),
            'enrichment_plan' => $this->enrichmentPlanner->plan($type, $entityId)->toArray(),
        ];
    }
}

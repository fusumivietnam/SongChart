...
Current stage: **17.8 — Canonical Data Fusion Foundation + Public URL Canonicalization**
...
- Stage: `17.8 — Canonical Data Fusion Foundation + Public URL Canonicalization`
...
Stage 17.8 establishes provider-neutral field-level evidence fusion on the existing provenance schema, exposes an Entity Data Passport, and makes plural type-specific public URLs the only canonical detail surface. Legacy `/entity/*` and singular local aliases are removed without redirects because the catalog is not yet public/indexed.

...
Current stage: **17.8.1 — Public Taxonomy & Detail Runtime Corrective**
...
Stage 17.8.1 closes the Stage 17.8 detail/runtime regressions and makes public Artist routing subtype-aware: person artists use `/artists/*`, while group/orchestra/choir artists use `/groups/*`. Canonical Artist identity remains unchanged and legacy generic/singular routes remain absent without redirects.

...
return [
    ...
    'operational_intelligence' => [
        'required_scale_dimensions' => ['runtime', 'queue', 'database', 'cache', 'provider'],
        'external_observability' => [
            'decision' => 'deferred',
            'reason' => 'Pulse, Horizon and repository-owned evidence cover the accepted baseline; adopt external APM only after a measured gap is recorded.',
        ],
        'metrics' => [
            'database_probe_ms' => [
                'dimension' => 'database',
            ...
            'queue_depth' => [
                ...
                'direction' => 'higher_is_worse',
                'warning' => (int) env('SONGCHART_QUEUE_MONITOR_MAX', 100),
                'critical' => (int) env('SONGCHART_QUEUE_MONITOR_CRITICAL', 500),
            ],
            'pulse_slow_events_15m' => [
                'dimension' => 'runtime',
                'unit' => 'events',
                'owner' => 'laravel-pulse',
                'direction' => 'higher_is_worse',
            ...
            'provider_sync_failures_24h' => [
                'dimension' => 'provider',
                'unit' => 'runs',
                'owner' => 'provider-sync-runs',
                'direction' => 'higher_is_worse',
                'warning' => 1,
                'critical' => 3,
            ],
            'provider_sync_age_minutes' => [
                'dimension' => 'provider',
                'unit' => 'minutes',
                'owner' => 'provider-sync-runs',
                'direction' => 'higher_is_worse',
                'warning' => (int) env('SONGCHART_PROVIDER_HEALTH_STALE_AFTER_MINUTES', 15),
                'critical' => max(60, (int) env('SONGCHART_PROVIDER_HEALTH_STALE_AFTER_MINUTES', 15) * 4),
            ],
            'provider_import_failures_24h' => [
                'dimension' => 'provider',
                'unit' => 'runs',
                'owner' => 'provider-import-runs',
                'direction' => 'higher_is_worse',
                'warning' => 1,
                'critical' => 3,
            ],
            ...
            'open_identity_conflicts' => [
                'dimension' => 'provider',
                'unit' => 'reviews',
                'owner' => 'identity-conflict-reviews',
                'direction' => 'higher_is_worse',
                'warning' => 1,
                'critical' => 10,
            ],
            'search_visibility' => [
                'dimension' => 'search',
                'unit' => 'score',
                'owner' => 'external-search-evidence',
                'direction' => 'lower_is_worse',
                'warning' => 0.7,
                'critical' => 0.4,
            ],

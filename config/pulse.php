...
return [
    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            ...
            'groups' => ['/^job-exceptions:.*/' => 'job-exceptions:*'],
        ],
        ...
        Recorders\Servers::class => [
            ...
            'directories' => explode(':', env('PULSE_SERVER_DIRECTORIES', base_path())),
        ],
        ...
        Recorders\SlowQueries::class => [
            ...
            'max_query_length' => env('PULSE_SLOW_QUERIES_MAX_QUERY_LENGTH', 16384),
            'ignore' => [
                '/(["`])pulse_[\\w]+?\\1/',
                '/(["`])telescope_[\\w]+?\\1/',
            ],

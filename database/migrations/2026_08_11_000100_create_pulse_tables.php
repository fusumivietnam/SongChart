...
return new class extends PulseMigration
{
    public function up(): void
    {
        ...
        Schema::create('pulse_values', function (Blueprint $table) {
            ...
            match ($this->driver()) {
                ...
                default => throw new LogicException('Unsupported Pulse database driver ['.$this->driver().'].'),
            };
    ...
    {
        throw new class('Unsupported Pulse database driver ['.$this->driver().'].') extends Exception {};
    }

...
4. Read `docs/project/engineering/project-knowledge.json` and `docs/project/engineering/consolidation-plan.json`.
...
7. Use `./songchart impact <paths...>` when the planned change surface is known.
